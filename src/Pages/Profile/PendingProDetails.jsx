...
// export function PendingProfileDetails() {
...
// const backuButtonUrl ='/BrokerPendingList?'
...
//               <button onClick={() => onCancelClick()} className="btn btn-success">Approve</button>
//               <button className="btn btn-danger" onClick={handleShow}>Reject</button>
//        </div>
