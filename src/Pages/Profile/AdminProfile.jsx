...
import tamilFont from '../Broker/TamilFontBase64'
        ...
        columns: [
          {
            ...
            stack: [
                ...
                { text: 'Profile ID ', margin: [0, 0, 0, 8] }, // Added margin bottom
                { text: 'Gender ', margin: [0, 0, 0, 8] }, // Added margin bottom
                { text: 'Date of birth', margin: [0, 0, 0, 8] },
                { text: 'Time of birth', margin: [0, 0, 0, 8] },
                { text: 'Height(cm)', margin: [0, 0, 0, 8] },
                { text: 'Weight(kg)', margin: [0, 0, 0, 8] },
                { text: 'Colour', margin: [0, 0, 0, 8] },
                { text: 'Mother Tongue ', margin: [0, 0, 0, 8] },
                { text: 'Star ', bold: true, margin: [0, 0, 0, 8] },
                { text: 'Rasi', margin: [0, 0, 0, 8] },
                { text: 'Qualification', margin: [0, 0, 0, 8] }, // Added margin bottom
                { text: 'Job Title ', bold: true, margin: [0, 0, 0, 8] },
                { text: 'Salary per month', margin: [0, 0, 0, 8] },
                { text: 'Father Name', margin: [0, 0, 0, 8] },
                { text: 'Father Occupation', margin: [0, 0, 0, 8] },
                { text: 'Mother Name', margin: [0, 0, 0, 8] },
                { text: 'Mother Occupation', margin: [0, 0, 0, 8] },
          ...
          },
          {
            ...
            stack: [
                ...
                { text: profile.profileDetails.profileID || "-", margin: [0, 0, 0, 8] },
                { text: profile.profileDetails.sex || "-", margin: [0, 0, 0, 8] },
                { text: profile.profileDetails.DOB || "-", margin: [0, 0, 0, 8] },
                { text: profile.profileDetails.birthTime || "-", margin: [0, 0, 0, 8] },
                { text: profile.profileDetails.height || "-", margin: [0, 0, 0, 8] },
                { text: profile.profileDetails.weight || "-", margin: [0, 0, 0, 8] },
                { text: profile.profileDetails.colour || "-", margin: [0, 0, 0, 8] },
                { text: profile.profileDetails.motherTongue || "-", margin: [0, 0, 0, 8] },
                ...
                { text: profile.profileDetails.fatherName || "-", margin: [0, 0, 0, 8] },
                { text: profile.profileDetails.fatherOccupation || "-", margin: [0, 0, 0, 8] },
                { text: profile.profileDetails.motherName || "-", margin: [0, 0, 0, 8] },
                { text: profile.profileDetails.motherOccupation || "-", margin: [0, 0, 0, 8] },
        ...
        columns: [
          {
            width: '20%',
            stack: [
              { text: 'திசை இருப்பு : ', bold: true, margin: [0, 0, 0, 1] }, // Added margin bottom
            
            ],
          },
          {
            width: '20%',
            stack: [ { text: profile?.profileDetails?.horoScope?.dhasa, bold: true, margin: [0, 0, 0, 1] }, // Added margin bottom
          ...
          },
          {
            width: '3%',
            stack: [
              { text:  profile?.profileDetails?.horoScope?.year, bold: true, margin: [0, 0, 0, 1] },
          ...
          },
          {
            width: '15%',
            stack: [
              { text: 'வருடம்', bold: true, margin: [0, 0, 0, 1] },
          ...
          },
          {
            width: '3%',
            stack: [
              { text: profile?.profileDetails?.horoScope?.month, bold: true, margin: [0, 0, 0, 1] },
          ...
          },
          {
            width: '10%',
            stack: [
              { text: 'மாதம்', bold: true, margin: [0, 0, 0, 1] },
          ...
          },
          {
            width: '3%',
            stack: [
              { text:  profile?.profileDetails?.horoScope?.day, bold: true, margin: [0, 0, 0, 1] },
          ...
          },
          {
            width: '10%',
            stack: [
              { text: 'நாள்', bold: true, margin: [0, 0, 0, 1] },
...
const backuButtonUrl ='/AdminPendingList?'
...
const backEditHoroscope ='/AddProfileImage?id='+ profileId
          ...
          <div className="col-md-8">
            ...
            {profile.isProfileDetailsByIdSuccess && !profile.isProfileDetailsByIdLoading && (
                <>
                  ...
                  <div className="row">
                    <label  style={{ fontWeight: 'bold' }} className="col-3 col-form-label">Name</label>
                    <div className="col-8">
                  ...
                  <div className="row">
                    <label  style={{ fontWeight: 'bold' }} className="col-3 col-form-label">Qualification</label>
                    <div className="col-8">
                  ...
                  <div className="row">
                    <label  style={{ fontWeight: 'bold' }} className="col-3 col-form-label">Job</label>
                    <div className="col-8">
                  ...
                  <div className="row">
                    <label  style={{ fontWeight: 'bold' }} className="col-3 col-form-label">Salary per month</label>
                    <div className="col-8">
                  ...
                  <div className="row">
                    <label  style={{ fontWeight: 'bold' }} className="col-3 col-form-label">Father Name</label>
                    <div className="col-8">
                  ...
                  <div className="row">
                    <label  style={{ fontWeight: 'bold' }} className="col-3 col-form-label">Mother Name</label>
                    <div className="col-8">
                  ...
                  <div className="row">
                    <label  style={{ fontWeight: 'bold' }} className="col-3 col-form-label">Father Occupation</label>
                    <div className="col-8">
                  ...
                  <div className="row">
                    <label  style={{ fontWeight: 'bold' }} className="col-3 col-form-label">Mother Occupation</label>
                    <div className="col-8">
                  ...
                  <div className="row">
                    <label  style={{ fontWeight: 'bold' }} className="col-3 col-form-label">Religion</label>
                    <div className="col-8">
                  ...
                  <div className="row">
                    <label  style={{ fontWeight: 'bold' }} className="col-3 col-form-label">Caste</label>
                    <div className="col-8">
                  ...
                  <div className="row">
                    <label  style={{ fontWeight: 'bold' }} className="col-3 col-form-label">District</label>
                    <div className="col-8">
                  ...
                  <div className="row">
                    <label  style={{ fontWeight: 'bold' }} className="col-3 col-form-label">State</label>
                    <div className="col-8">
                    <label  className="form-control-plaintext">: {profile.profileDetails.state}</label>
                    </div>
                  </div>
                  <div className="row">
                    <label  style={{ fontWeight: 'bold' }} className="col-3 col-form-label">Phone No</label>
                    <div className="col-8">
                  ...
                  <div className="row">
                    <label  style={{ fontWeight: 'bold' }} className="col-3 col-form-label">Status</label>
                    <div className="col-8">
  ...
  <br></br>
    ...
    <p className="h4">Horoscope Details</p>
...
{/* 
    ...
    <div className="row">
    <label  style={{ fontWeight: 'bold' }} className="col-2 col-form-label">Created Date</label>
    <div className="col-9">
    ...
    <div className="row">
    <label  style={{ fontWeight: 'bold' }} className="col-2 col-form-label">Created By</label>
    <div className="col-9">
    ...
    <div className="row">
    <label  style={{ fontWeight: 'bold' }} className="col-2 col-form-label">Last Updated Date</label>
    <div className="col-9">
    ...
    <div className="row">
    <label  style={{ fontWeight: 'bold' }} className="col-2 col-form-label">Last Updated By</label>
    <div className="col-9">
...
<div className="row" >
       <div className="button-container">
              ...
              <button onClick={() => onCancelClick()}  style={{width:85}} className="btn btn-success">Approve</button>
              <button className="btn btn-danger" style={{width:85}} onClick={handleShow}>Reject</button>
       </div>
...
<Modal show={show} onHide={handleClose}>
        <Modal.Header closeButton>
          <Modal.Title>Reject Profile</Modal.Title>
        </Modal.Header>
        <Modal.Body>
