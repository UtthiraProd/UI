...

        {
          columns: [
            ...
            },
            {
              width: '5%',
              stack: [
              { text: ':', bold: true, margin: [0, 0, 0, 8] }, // Added margin bottom
            ...
            <div id="dvhoroscope" className="row">
              ...
              <div className="col-md-4">
                ...
                <div className="row">
                  ...
                  <div className="col-8">
                    <label className="form-control-plaintext">: {profile.profileDetails.birthHour}:{profile.profileDetails.birthMin} {profile.profileDetails.meridiem}</label>
                  </div>
                </div>
        ...
        <div id="dvbrokerDetails" className="row">
          <div className="col-md-12">
            ...
            <div className="row">
              ...
              <div className="col-9">
                <label className="form-control-plaintext">: {profile.profileDetails.updatedBy} </label>
              </div>
            </div>
          </div>
        </div>
