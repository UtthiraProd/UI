...
export function UserDisplayProfile() {
...
<p className="h6 mb-0 ms-2">Go Back</p></Link>
  ...
  <div className="row">
    ...
    <label  className="form-control-plaintext">: {profile.profileDetails.status}</label>
        ...
        profile && profile.Images && profile.Images.length > 0 ? (
          ...
          <div><Link to={backEditHoroscope} className="dropdown-item">

          <p>
            No - <span style={{ fontWeight: 'bold', color: '#ff5722' }}>Image</span> available. 
            <span 
...
<div className="form-group col-12">
    ...
    <div className="row">
      ...
      <div className="row">
        <Link to={backEditHoroscope} className="dropdown-item">
          ...
          <p>
            No horoscope - <span style={{ fontWeight: 'bold', color: '#ff5722' }}>ராசி</span> info available. 
            <span 
              style={{ cursor: 'pointer', color: '#1aa179', display: 'inline-flex', alignItems: 'center', marginLeft: '8px'}} 
            >
              Add Horoscope
  ...
  <div className="row">
    <Link to={backEditHoroscope} className="dropdown-item">
      ...
      <p>
        No horoscope - <span style={{ fontWeight: 'bold', color: '#ff5722' }}>அம்சம்</span> info available. 
        <span 
              style={{ cursor: 'pointer', color: '#1aa179', display: 'inline-flex', alignItems: 'center', marginLeft: '8px'}} 
            >
              Add Horoscope
